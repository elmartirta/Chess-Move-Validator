...
class MoveTestSuite():
    ...
    def test1():
        m = Move.fromAN("Ra1")
        assert(m.destination == Vector.fromAN("a1") and m.pieceType == "R")
        assert(m.isCapture == False)
        assert(m.isCheck == False)
        assert(m.isCheckmate == False)
        m = Move.fromAN("Ba1+")
        assert(m.destination == Vector.fromAN("a1") and m.pieceType == "B")
        assert(m.isCapture == False)
        ...
        m = Move.fromAN("Pxa1#")
        assert(m.destination == Vector.fromAN("a1") and m.pieceType == "P")
        assert(m.isCapture == True)
        assert(m.isCheck == False)
        assert(m.isCheckmate == True)        
        return True
    def test2():
        ...
        assert(m.isCheckmate == False)
        m = Move.fromAN("Qbxa1#")
        assert(m.destination == Vector.fromAN("a1") and m.pieceType == "Q" and m.source == Vector.fromAN("b"))
        assert(m.isCapture == True)
        assert(m.isCheck == False)
        assert(m.isCheckmate == True)
        m = Move.fromAN("Bbxa1#")
        assert(m.destination == Vector.fromAN("a1") and m.pieceType == "B" and m.source == Vector.fromAN("b"))
        assert(m.isCapture == True)
        assert(m.isCheck == False)
        assert(m.isCheckmate == True)
        return True
    def test3():
        ...
        assert(m.isCheckmate == False)
        m = Move.fromAN("Q8xa1#")
        assert(m.destination == Vector.fromAN("a1") and m.pieceType == "Q" and m.source == Vector.fromAN("8"))
        assert(m.isCapture == True)
        assert(m.isCheck == False)
        assert(m.isCheckmate == True)
        m = Move.fromAN("B4xa1#")
        assert(m.destination == Vector.fromAN("a1") and m.pieceType == "B" and m.source == Vector.fromAN("4"))
        assert(m.isCapture == True)
        assert(m.isCheck == False)
        assert(m.isCheckmate == True)
        return True
    def test4():
        ...
        assert(m.pieceType == "B" and m.destination == Vector.fromAN("h8") and m.source == Vector.fromAN("a1"))
        assert(m.isCapture == True)
        assert(m.isCheck == False)
        assert(m.isCheckmate == True)
        m = Move.fromAN("Ba2h8+")
        assert(m.pieceType == "B" and m.destination == Vector.fromAN("h8") and m.source == Vector.fromAN("a2"))
        assert(m.isCapture == False)
        assert(m.isCheck == True)
        assert(m.isCheckmate == False)
        return True
    def test5():
        m = Move.fromAN("e4")        
        assert(m.pieceType == "P" and m.destination == Vector.fromAN("e4"))
        assert(m.isCapture == False)
        assert(m.isCheck == False)
        assert(m.isCheckmate == False)
        m = Move.fromAN("e4+")        
    ...
    def test7():
        m = Move.fromAN("h8=Q")
        assert(m.pieceType == "P" and m.destination == Vector.fromAN("h8"))
        assert(m.isCapture == False)
        assert(m.isCheck == False)
        assert(m.isCheckmate == False)
        assert(m.promotionPiece == "Q")
        m = Move.fromAN("a8=R+")
        assert(m.pieceType == "P" and m.destination == Vector.fromAN("a8"))
        assert(m.isCapture == False)
        assert(m.isCheck == True)
        assert(m.isCheckmate == False)
        assert(m.promotionPiece == "R")
        m = Move.fromAN("f8=N#")
        assert(m.pieceType == "P" and m.destination == Vector.fromAN("f8"))
        assert(m.isCapture == False)
        assert(m.isCheck == False)
        assert(m.isCheckmate == True)
    ...
    def test8():
        ...
        assert(m.pieceType == "P" and m.destination == Vector.fromAN("a8") and m.source == Vector.fromAN("b"))
        assert(m.isCapture == False)
        assert(m.isCheck == True)
        assert(m.isCheckmate == False)
        assert(m.promotionPiece == "Q")
        m = Move.fromAN("gxh8=R#")
        assert(m.pieceType == "P" and m.destination == Vector.fromAN("h8") and m.source == Vector.fromAN("g"))
        assert(m.isCapture == False)
        assert(m.isCheck == False)
        assert(m.isCheckmate == True)
        assert(m.promotionPiece == "R")
